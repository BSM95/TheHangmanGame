const words = [
    ...
    },
    {
        id: 38,
        answer: 'نايف حمدان',
        hint: 'صانع محتوى سعودي اشتهر بسرده القصص التاريخية بأسلوب فكاهي',
        category: 'شخصيات',
    },
    {
        id: 39,
    ...
    },
    {
        id: 49,
        answer: 'ستيفن جيرارد',
        hint: 'إسم لاعب حصلت له أسرع حالة طرد للاعب بديل',
        category: 'رياضة',
    },
    {
        id: 50,
        answer: 'هيثم بن طارق',
        hint: 'حاكم لدولة خليجية',
        category: 'شخصيات',
    },
    {
        id: 51,
        answer: 'بابا فرحان',
        hint: 'مسلسل أطفال عالق في ذاكرة الكثير من الشباب الخليجي',
        category: 'عروض',
    },
    {
        id: 52,
        answer: 'تفاح',
        hint: 'فاكهة يضرب بها المثل عند أكلها لا حاجة للذهاب إلى الطبيب',
        category: 'أغذية',
    },
    {
        id: 53,
        answer: 'الصحراء الكبرى',
        hint: 'صخراء ممتدة من المغرب إلى جنوب مصر',
        category: 'جغرافيا',
    },
    {
        id: 54,
        answer: 'النسناس',
        hint: 'وحش أسطوري كانت تؤمن به العرب قبل الإسلام',
        category: 'تاريخ',
    },
    {
        id: 55,
        answer: 'البرازيل',
        hint: 'وصيف أول نسخة لكأس العالم',
        category: 'رياضة',
    },
    {
        id: 56,
        answer: 'محمد الشهري',
        hint: 'محترف العاب إلكترونية سعودي حقق إنجازات في هذا المجال',
        category: 'شخصيات',
    }
